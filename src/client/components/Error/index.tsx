...
export const ErrorComp: Component<IProps> = (p) => (
  <>
    {'<!DOCTYPE html>'}

    <html lang="en">
      <head>
        <title>We're sorry, but something went wrong ({p.code})</title>
...
export const ErrorContent: Component<IProps> = (p) => (
  <div class="container mx-auto px-4">
    <section class="py-8 px-4 text-center">
      <div class="max-w-auto mx-auto">
        ...
        <p class="mt-6 uppercase text-sm lg:text-base text-gray-900">
          Error code: {p.code}, message:
        </p>

        <br />

        <code>
          <pre innerHTML={p.message} />
        </code>
